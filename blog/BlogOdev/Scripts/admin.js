function returnMyLink(cellvalue, options, rowObject) {
    return "<a href='/Admin/ImagesForPost/" + rowObject.Id + "' target='_parent'><img width='100' height:'100' src='/Content/images/" + rowObject.FirstImage + "'/></a>";
}
...
$(function () {
  ...
  BlogOdev.GridManager = {};

  //************************* POSTS GRID
  BlogOdev.GridManager.postsGrid = function (gridName, pagerName) {
    ...
    var addOptions = {
      url: '/Admin/AddPost',
      addCaption: 'Yazı Ekle',
      processData: "Kaydediliyor...",
      width: 900,
      closeAfterAdd: true,
      closeOnEscape: true,
      ...
      onClose: onClose,
      afterSubmit: BlogOdev.GridManager.afterSubmitHandler,
      beforeSubmit: beforeSubmitHandler
    };

    var editOptions = {
      url: '/Admin/EditPost',
      editCaption: 'Yazı düzenleme',
      processData: "Kaydediliyor...",
      width: 900,
      closeAfterEdit: true,
      closeOnEscape: true,
  ...
  //************************* CATEGORIES GRID
  BlogOdev.GridManager.categoriesGrid = function (gridName, pagerName) {
    ...
    var editOptions = {
      ...
      afterSubmit: function (response, postdata) {
        ...
        return [false, "Sunucudan sonuç alınamadı.", null];
      }
    };
    ...
    var deleteOptions = {
      ...
      processData: "Saving...",
      width: 500,
      msg: "Kategoriyi sil? Bu, tüm mesajlar da bu kategoriye ait olanları silecektir..",
      closeOnEscape: true,
      afterSubmit: BlogOdev.GridManager.afterSubmitHandler
    };
  ...
  //************************* TAGS GRID
  BlogOdev.GridManager.tagsGrid = function (gridName, pagerName) {
    var colNames = ['Id', 'Name', 'Url Slug', 'Description'];
    ...
    var deleteOptions = {
      ...
      processData: "Saving...",
      width: 500,
      msg: "Etiketi sil? Bu, tüm mesajlar da bu etikete ait mesajları silecektir.",
      closeOnEscape: true,
      afterSubmit: BlogOdev.GridManager.afterSubmitHandler
    };
  ...
  BlogOdev.GridManager.afterSubmitHandler = function (response, postdata) {
  ...
  $("#tabs").tabs({
    show: function (event, ui) {
      ...
      if (!ui.tab.isLoaded) {
        ...
        var gdMgr = BlogOdev.GridManager,
