...
namespace BlogOdev.Core
{
    ...
    public interface IBlogRepository
    {
        ...
        /// <returns></returns>
        IList<Image> ImagesForPost(int postId);
        ...
        /// <param name="postId"></param>
        /// <returns></returns>
        Image FirstImageForPost(int postId);
        ...
        /// <summary>
        /// Return collection of posts belongs to a particular author.
        /// </summary>
        /// <param name="author">author</param>
        /// <param name="pageNo">Page index</param>
        /// <param name="pageSize">Page size</param>
        /// <returns></returns>
        IList<Post> PostsForAuthor(string author, int pageNo, int pageSize);
        ...
        /// <summary>
        /// Return total no. of posts belongs to a particular author.
        /// </summary>
        /// <param name="author">author</param>
        /// <returns></returns>
        int TotalPostsForAuthor(string author);
