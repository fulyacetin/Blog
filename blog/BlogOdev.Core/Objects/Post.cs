...
namespace BlogOdev.Core.Objects
{
    public class Post
    {
        ...
        [StringLength(500, ErrorMessage = "FirstImage: FirstImage should not exceed 500 characters")]
        public virtual string FirstImage { get; set; }

        [StringLength(50, ErrorMessage = "Author: Author should not exceed 50 characters")]
